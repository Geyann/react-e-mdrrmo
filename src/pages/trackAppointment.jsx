          ...
          {appointments.length === 0 && !error ? (
            <div className="text-center py-16">
              ...
              <button
                ...
                className="mt-6 px-6 py-3 bg-purple-600 text-white rounded-xl font-bold hover:bg-purple-700 transition shadow-lg"
              >
                Book Appointment
              </button>
            </div>
            ...
            <div className="space-y-4">
              {appointments.map((appt) => (
                <div
                  ...
                  className="p-5 bg-gray-50 rounded-xl border border-gray-200 hover:border-purple-300 transition"
                >
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="space-y-2">
                      ...
                      {appt.purpose && (
                        <p className="font-bold text-gray-800">{appt.purpose}</p>
                      )}
                      {appt.reason && (
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {appt.fullName && (
                        <span className="text-sm text-gray-500 flex items-center gap-1">
                          <User className="w-3 h-3" /> {appt.fullName}
                        </span>
                      )}
                    </div>
                  </div>
