...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    // Check if user exists in pending_registrations with approved status
    ...
    // profile.status === 'approved' — allow login
    navigate("/home");
    setLoading(false);
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center from-blue-50 to-purple-50 p-4">
      <button
        onClick={() => navigate('/')}
            ...
            <form onSubmit={handleLogin} className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-3 mb-6">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-xl hover:bg-gray-50 transition font-semibold text-gray-700 disabled:opacity-50"
                >
                  {oauthLoading === 'google' ? (
                ...
                <button
                  ...
                  disabled={oauthLoading !== null}
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-[#1877F2] text-white rounded-xl hover:bg-[#166fe5] transition font-semibold disabled:opacity-50"
                >
